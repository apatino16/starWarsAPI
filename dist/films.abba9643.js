...
})({"eLq8q":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4997d46cabba9643";
"use strict";
...
},{}],"cWJd5":[function(require,module,exports) {
...
async function getFilm() {
    try {
        ...
        if (filmNumber.ok) {
            ...
            filmInfo1.innerHTML = `<h2><strong>${filmResponse.results[0].title}</strong></h2>
            ...
            filmInfo2.innerHTML = `<h2><strong>${filmResponse.results[1].title}</strong></h2>
            ...
            filmInfo3.innerHTML = `<h2><strong>${filmResponse.results[2].title}</strong></h2>
            ...
            filmInfo4.innerHTML = `<h2><strong>${filmResponse.results[3].title}</strong></h2>
            ...
            filmInfo5.innerHTML = `<h2><strong>${filmResponse.results[4].title}</strong></h2>
            ...
            filmInfo6.innerHTML = `<h2><strong>${filmResponse.results[5].title}</strong></h2>
...
},{}]},["eLq8q","cWJd5"], "cWJd5", "parcelRequire67c6")

//# sourceMappingURL=films.abba9643.js.map
