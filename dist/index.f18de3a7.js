...
})({"1TEXk":[function(require,module,exports) {
...
let ranNum = Math.floor(Math.random() * 83 + 1);
...
async function getCharacter() {
    try {
        ...
        if (response.ok) {
            ...
            responseField.innerHTML = `<text> <strong> ${jsonResponse.name} </strong></text>
...
},{}]},["1TEXk","7SwCM"], "7SwCM", "parcelRequire67c6")
